...
export default function Index({
    ...
    // Auto-refresh every 30s when at least one bot is active
    useEffect(() => {
    ...
    // Full-page empty state when no bots at all
            ...
            <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 gap-5 lg:grid-cols-12">
                    ...
                    <Card className="lg:col-span-5">
                        ...
                        <CardContent>
                            {pnlChart.length === 0 ? (
                                <div className="flex items-center gap-4 rounded-lg bg-muted/30 border border-dashed px-4 py-3">
                                    <Activity className="h-5 w-5 text-muted-foreground shrink-0" />
                                    <div>
                                        <p className="text-xs font-medium">Sin historial de PNL aún</p>
                                        <p className="text-[11px] text-muted-foreground mt-0.5">
                                            Aparecerá aquí a medida que el bot opere
                                        </p>
                                    </div>
                                </div>
                            ) : (
                                        ...
                                        >
                                            <defs>
                                                <linearGradient id="dashPnl" x1="0" y1="0" x2="0" y2="1">
                                                    ...
                                                    <stop offset="95%" stopColor="#22a962" stopOpacity={0} />
                                                </linearGradient>
                                                <linearGradient id="dashGrid" x1="0" y1="0" x2="0" y2="1">
                                            ...
                                            />
                                            <Area type="monotone" dataKey="total_pnl" stroke="#22a962" fill="url(#dashPnl)" strokeWidth={2} name="PNL Total" />
                                            <Area type="monotone" dataKey="grid_profit" stroke="#3b82f6" fill="url(#dashGrid)" strokeWidth={2} name="Grid Profit" />
                                        </AreaChart>
                                    </ResponsiveContainer>
                                </div>
                            )}
                            {pnlChart.length > 0 && (
                                <div className="mt-2 flex items-center gap-4 text-[10px] text-muted-foreground">
                                    <span className="flex items-center gap-1">
                                        <span className="h-1.5 w-1.5 rounded-full bg-green-500" /> PNL Total
                                    </span>
                                    <span className="flex items-center gap-1">
                                        <span className="h-1.5 w-1.5 rounded-full bg-blue-500" /> Grid
                                    </span>
                                </div>
                            )}
                        </CardContent>
                    ...
                    <Card className="lg:col-span-4">
                        ...
                        <CardContent>
                            {activeBots.length === 0 ? (
                                <div className="flex items-center gap-3 rounded-lg bg-muted/30 border border-dashed px-4 py-3">
                                    <BotIcon className="h-5 w-5 text-muted-foreground shrink-0" />
